		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<div class="table-box">
						...
						<table id="dataList"
							...
							<tbody>
							<c:forEach items="${ordersListPage.list}" var="order">
								<tr>
				...
				<div class="box-footer">
					<div class="pull-left">
						<div class="form-group form-inline">
							总共${ordersListPage.pages}页，共${ordersListPage.total}条数据。
							每页 <select class="form‐control" onchange="submitPageSize(this)"  id="pageSelect">
							<option value="5"
									<c:if test="${ordersListPage.pageSize==5}">
										selected
									</c:if>>
								5
							</option>
							<option value="10"
									<c:if test="${ordersListPage.pageSize==10}">
										selected
									</c:if>>
								10
							</option>
					...
					<script type="text/javascript">
                        function submitPageSize(who) {
                            ...
                            // alert(who.value);
                            // 发送请求
                            location.href = "${pageContext.request.contextPath}/Orders/findAllOrder?pageNum=${ordersListPage.pageNum}&pageSize=" + who.value;
                        }
					</script>
					<div class="box‐tools pull‐right">
						<ul class="pagination">
							<li><a href="javascript:submitPageNum(1)"  aria‐label="Previous">首页</a></li>
							<li><a href="javascript:submitPageNum(${ordersListPage.prePage})">上一页</a></li>
							<c:forEach begin="1" end="${ordersListPage.pages}" var="i">
								<li><a href="javascript:submitPageNum(${ i})">${ i }</a></li>
							</c:forEach>
							<li><a href="javascript:submitPageNum(${ordersListPage.nextPage})">下一页</a></li>
							<li><a href="javascript:submitPageNum(${ordersListPage.pages})"  aria‐label="Next">尾页</a></li>
						</ul>
					</div>
					<script type="text/javascript">
                        // 提交当前页
                        function submitPageNum(pageNum) {
                            location.href = "${pageContext.request.contextPath}/Orders/findAllOrder?pageSize=${ordersListPage.pageSize}&pageNum=" + pageNum};
					</script>
