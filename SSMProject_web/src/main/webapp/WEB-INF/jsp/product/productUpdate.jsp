...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form action="${pageContext.request.contextPath}/Product/updateProductInfo"
				method="post">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="productStatus">
								<option value="0" ${product.productStatus==0? "selected":""}>无效</option>
								<option value="1" ${product.productStatus==0? "selected":""}>有效</option>
							</select>
						</div>
